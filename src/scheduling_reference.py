...
def factory_angle_execution(n_factories, target_qubits_angles):
    ...
    while primary_queue:
        # TODO: 1) one queue for all possible angles to be prepared, with priority
        # 2) function to get the angle to be executed in the current stage.
        # Not assign factories to specific angles yet (to be done in the separate step)
        # 3) function to assign idle factories to angles
        # 4) function to simulate the whole circuit execution
        ...
        # TODO: recieve signal for TMR and injection: list, list
