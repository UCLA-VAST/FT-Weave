...
def _plot_star_vs_t_cultivation_best(
    ...
    *,
    ...
    fig, axes = plt.subplots(len(target_aods), len(layer_order), figsize=(3.54, 1.88))
...
def _plot_t_cultivation_compile_ablation(
    ...
    **first** ``(code_distance, fidelity_target, factory_physical_size)`` in
    ...
    for distance in distances:
        ...
        fig.subplots_adjust(top=0.85, bottom=0.35, wspace=0.22)
...
def _plot_star_t_microarchitecture_comparison_grid(
    ...
    *,
    ...
    fig, axes = plt.subplots(2, 2, figsize=(3.54, 2.78), squeeze=False)
    ...
    fig.tight_layout(rect=(0.06, 0.12, 0.98, 0.8), pad=0.10, w_pad=0.12, h_pad=0.35)
    fig.subplots_adjust(
        top=0.88,
        bottom=0.18,
        left=0.06,
...
def _plot_star_t_aod_comparison_grid(
    ...
    *,
    ...
    fig, axes = plt.subplots(1, 2, figsize=(3.54, 1.64), squeeze=False)
    ax_star = axes[0, 0]
    ax_t = axes[0, 1]
    ...
    fig.tight_layout(rect=(0.06, 0.18, 0.98, 0.88), pad=0.10, w_pad=0.14, h_pad=0.12)
    fig.subplots_adjust(
        top=0.86,
        bottom=0.28,
        left=0.07,
